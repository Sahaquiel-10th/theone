import { usagePower, powerText, type PowerUsage } from "./usagePower";
export function CacheUsageDetails({ row }: { row: PowerUsage }) {
  ...
  return <div className="cache-usage-details"><p>输入 {powerText(value.input)} 电力 · 输出 {powerText(value.output)} 电力</p>
