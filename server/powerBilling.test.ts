...
function database(): Database {
  return {
    users: [], workspaces: [], workspaceMembers: [], conversationFolders: [], models: [], conversations: [], messages: [], userSavedMemories: [], retrievalLogs: [], modelUsageRecords: [], knowledgeConnections: [], oneKeyDevices: [], deviceChallenges: [], oneTimeLoginCodes: [],
    powerAccounts: [
